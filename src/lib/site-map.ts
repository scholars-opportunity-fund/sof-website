...
export const SITE_SECTIONS = {
  process: { name: 'Investment process', href: '/about#investment-process', description: 'Follow an idea from sourcing and diligence to investment committee and monitoring.' },
  approach: { name: 'The approach', href: '/about#approach', description: 'Explore our focus on public equities, special situations, and event-driven opportunities.' },
